/**
 * @generated SignedSource<<1d3891021f2dad38fa82b8e74a1856be>>
...
export type profileLikesListFragment$data = {
  readonly id: string;
  readonly likedBibleVersePosts: {
  ...
  readonly " $fragmentType": "profileLikesListFragment";
};
export type profileLikesListFragment$key = {
  readonly " $data"?: profileLikesListFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"profileLikesListFragment">;
};

import profileLikesListPaginationQuery_graphql from './profileLikesListPaginationQuery.graphql';

const node: ReaderFragment = (function(){
var v0 = [
  "likedBibleVersePosts"
],
v1 = {
  "alias": null,
  "args": null,
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": profileLikesListPaginationQuery_graphql,
      "identifierInfo": {
        "identifierField": "id",
  ...
  "selections": [
    {
      "alias": "likedBibleVersePosts",
      "args": null,
      "concreteType": "BibleVersePostConnection",
      "kind": "LinkedField",
      "name": "__profileLikesList_likedBibleVersePosts_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
...
(node as any).hash = "9b793841dddf72b644fa8a7e75745fb2";
