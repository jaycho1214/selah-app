/**
 * @generated SignedSource<<ecf156b8902f48838618b6fa930fe113>>
...
export type postsScreenFollowingFeedFragment$data = {
  readonly followingBibleVersePosts: {
  ...
  readonly " $fragmentType": "postsScreenFollowingFeedFragment";
};
export type postsScreenFollowingFeedFragment$key = {
  readonly " $data"?: postsScreenFollowingFeedFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"postsScreenFollowingFeedFragment">;
};

import postsScreenFollowingFeedPaginationQuery_graphql from "./postsScreenFollowingFeedPaginationQuery.graphql";

const node: ReaderFragment = (function () {
  var v0 = ["followingBibleVersePosts"],
    v1 = {
      alias: null,
      args: null,
      kind: "ScalarField",
  ...
  return {
    ...
    metadata: {
      ...
      refetch: {
        ...
        operation: postsScreenFollowingFeedPaginationQuery_graphql,
      },
    },
    name: "postsScreenFollowingFeedFragment",
    selections: [
      {
        alias: "followingBibleVersePosts",
        args: null,
        concreteType: "BibleVersePostConnection",
        kind: "LinkedField",
        name: "__followingFeed_followingBibleVersePosts_connection",
        plural: false,
        selections: [
          {
            alias: null,
