...
export type IdCreateReflectionMutation$variables = {
  connections: ReadonlyArray<string>;
  input: BibleVersePostCreateInput;
};
export type IdCreateReflectionMutation$data = {
...
export type IdCreateReflectionMutation = {
  response: IdCreateReflectionMutation$data;
