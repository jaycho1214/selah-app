/**
 * @generated SignedSource<<d7379fa7bacdbe412dc52faf5e1cf585>>
...
return {
  ...
  "params": {
    "cacheID": "d3189549656bc7d93d3b2e5be49de173",
    "id": null,
    "metadata": {},
    "name": "chapterViewQuery",
    "operationKind": "query",
    "text": "query chapterViewQuery(\n  $translation: BibleTranslation!\n  $book: BibleBook!\n  $chapter: Int!\n) {\n  bibleVersesByReference(translation: $translation, book: $book, chapter: $chapter) {\n    id\n    verse\n    text\n  }\n}\n"
  }
};
})();

(node as any).hash = "8898686357eaa9b3e3d2f6112a95131c";
