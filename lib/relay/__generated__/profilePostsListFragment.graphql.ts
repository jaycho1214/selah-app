/**
 * @generated SignedSource<<4df6c46d0579a3324ce48bd6c862d3e4>>
...
export type profilePostsListFragment$data = {
  ...
  readonly id: string;
  readonly " $fragmentType": "profilePostsListFragment";
};
export type profilePostsListFragment$key = {
  readonly " $data"?: profilePostsListFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"profilePostsListFragment">;
};

import profilePostsListPaginationQuery_graphql from './profilePostsListPaginationQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": profilePostsListPaginationQuery_graphql,
      "identifierInfo": {
        "identifierField": "id",
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__profilePostsList_bibleVersePosts_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
...
(node as any).hash = "999966d748ae8b51949b457472f69c96";
